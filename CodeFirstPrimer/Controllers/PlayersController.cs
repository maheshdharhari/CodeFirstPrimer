...
namespace CodeFirstPrimer.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PlayerId,FirstName,LastName,Position,Salary,TeamName")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PlayerId,FirstName,LastName,Position,Salary,TeamName")] Player player)
        {
            if (ModelState.IsValid)
            {
